        ...
        <div class="row h-100">
            ...
            <div class="col-md-5 d-flex align-items-center justify-content-center p-4 p-md-5" style="z-index: 2;">
                <div class="glass-card">
                    ...
                    <h2 class="fw-normal mb-1">Exclusive Access</h2>
                    ...
                    <form action="/login-auth" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control form-control-custom py-2" placeholder="Masukan Email Anda" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control form-control-custom py-2 mt-2" placeholder="Masukan Password" required>
                        </div>

                        <div class="mb-4 form-check">
                            <input type="checkbox" class="form-check-input" id="stayAuth" name="remember">
                    ...
                    <div class="text-center" style="font-size: 0.8rem;">
                        <span class="text-muted">Don't have an account yet?</span> <a href="/register" class="text-honda-red text-decoration-none fw-bold">Register Now</a>
                    </div>
                </div>
            </div>
