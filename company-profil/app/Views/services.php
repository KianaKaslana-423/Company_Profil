...
<section class="py-5 bg-light">
        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-7 d-flex flex-column gap-4">
                ...
                <div class="position-relative rounded-4 overflow-hidden shadow-sm" style="height: 380px;">
                    <img src="<?= base_url('assets/images/Firman2.jpeg') ?>" class="w-100 h-100" style="object-fit: cover;" alt="Smart Maintenance">
    ...
    <div class="container">
        <div class="mb-4">
            <h4 class="fw-bold fst-italic"><span class="text-danger">LATEST</span> UPDATES & INSIGHTS</h4>
            <p class="text-muted small">Specialized information for your Honda ecosystem.</p>
        </div>
        ...
        <div class="row g-4">
            <?php if(!empty($pages) && is_array($pages)): ?>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm overflow-hidden" style="border-radius: 12px; transition: transform 0.3s ease;">
                            ...
                            <div class="position-relative" style="height: 200px;">
                                <img src="<?= base_url('assets/images/' . $img) ?>" class="w-100 h-100" style="object-fit: cover;" alt="<?= esc($page['title']) ?>">
                                <div class="position-absolute top-0 end-0 m-3">
                                    <span class="badge bg-danger fw-bold shadow-sm" style="font-size: 0.6rem;">NEW</span>
                                </div>
                            </div>
                            
                            <div class="card-body p-4">
                                <h6 class="fw-bold text-dark mb-2 text-uppercase" style="letter-spacing: 0.5px;"><?= esc($page['title']) ?></h6>
                                <p class="text-muted mb-4" style="font-size: 0.8rem; line-height: 1.6;">
                                    <?= substr(strip_tags($page['content']), 0, 90) ?>...
                                </p>
                                <a href="<?= base_url('/' . $page['slug']) ?>" class="text-danger fw-bold text-decoration-none small" style="letter-spacing: 1px;">
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <div class="col-12 text-center py-5 border rounded-4 bg-white shadow-sm">
                    <i class="fa-solid fa-box-open text-muted fs-1 mb-3 opacity-25"></i>
                    <p class="text-muted">Stay tuned for more Honda insights.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<style>
    /* Efek hover agar kartu terangkat sedikit */
    .card:hover {
